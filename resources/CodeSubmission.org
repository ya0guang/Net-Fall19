...
You should create a *PRIVATE* repository called *Net-Fall19* on IU Github. 
...
*IMPORTANT*: Add the =sicenet= user to your *Net-Fall19* repository.
 ...
 * Change directories to a scratch area. Create a bare clone of the *Net-Fall19*
   course repository using:

#+begin_src text
git clone --bare git@github.iu.edu:SICE-Networks/Net-Fall19
#+end_src

 * Enter the Net-Fall19 directory
 ...
 * Clone your *Net-Fall19*

 * cd into the Net-Fall19 directory. Add an upstream remote to your
   repository. 

#+begin_src text
git remote add upstream git@github.iu.edu:SICE-Networks/Net-Fall19.git
#+end_src
...
#+begin_src text
https://github.iu.edu/ezkissel/Net-Fall19/commit/1cde9d43e12b8a2e7371b33372b14a5e9a1f0d9c
#+end_src
